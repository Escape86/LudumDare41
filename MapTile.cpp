...
std::map<int, TileInfo> moonTileIdToInfoLookup		// { id, { spriteSheetRowOffset, spriteSheetColumnOffset, walkAble }}
{
	{ 0,{ 0, 0, true } },
	{ 1,{ 0, 1, false } },
	{ 2,{ 0, 2, false } },
...
std::map<int, TileInfo> pisserTileIdToInfoLookup		// { id, { spriteSheetRowOffset, spriteSheetColumnOffset, walkAble }}
{
	{ 0,{ 0, 0, false } },
	{ 1,{ 0, 1, true } },
	{ 2,{ 0, 2, true } },
